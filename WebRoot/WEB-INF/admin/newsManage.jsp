...
<table id="dg" title="新闻管理" class="easyui-datagrid" fitColumns="true" 
    ...
    <thead>
    	<tr>
    		...
    		<th field="author" width="100" align="center" >新闻作者</th>
    		
    		<th field="newsType.id" width="100" align="center" formatter="formatnewsTypeId" hidden="true">所属商品大类ID</th>
    		<th field="newsType.name" width="100" align="center" formatter="formatnewsTypeName">所属商品大类</th>
    		
    		
    		<th field="click" width="100" align="center" >点击量</th>
...
<div id="dlg" class="easyui-dialog" style="width: 750px;height: 450px;padding: 10px 20px"
  ...
  <form id="fm" method="post">
  	<table cellspacing="8px;">
  		...
  		<tr>
  			<td>所属类别：</td>
  			<td colspan="4"><input class="easyui-combobox" id="bName" name="news.newsType.id"  data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'typeName',url:'newsType_comboList.action'"/></td>
  		</tr>
  		<tr>
  			<td>新闻点击量：</td>
  			<td colspan="4"><input type="text" id="click" name="news.click" class="easyui-validatebox" required="true" style="width: 300px;"/></td>
  		</tr>
