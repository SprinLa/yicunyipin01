...
<body>
 ...
 <div style='width:100%;height:44px;text-align:center;margin:0 auto;margin-top:5px;border-bottom:#cccccc 0px solid;'>
    	<div style="width:1200px;height:44px;text-align:left;margin:0 auto;border-bottom:#cccccc 0px solid;background:url(${pageContext.request.contextPath}/images/mnu1_bg.png) repeat-x;">
			<div class="nav-wrap">
			 <div class="nav">
		   <%--  <div class="goods" style="background:url(${pageContext.request.contextPath}/images/mnu1_bg_2.png);">
                  <div>
                    <h2> <a>所有商品分类</a> </h2>
                  </div>
                  <% int i=1; %>
   ...
   <c:forEach items="${list}" var="parent">
                ...
                <ul class="nav-list cf">
                  ...
                  <li><a href="">产业政策</a></li></li>
                  <li>	<a href="">新品展示</a></li></li>
               <li><a href="">交易商城</a></li>
				<li><a href="">一村一品精品展示</a></li>
				<li><a href="">会员管理</a></li>
				<li><a href="">后台管理</a></li>
				<li><a href="">联系我们</a></li>
                </ul>
