 ...
 <div class="nav-wrap" style="background:url(${pageContext.request.contextPath}/images/mnu1_bg.png) repeat-x;">
			 <div style="margin-left:10%">
                <ul class="nav-list cf">
                  ...
                  <li><a href="${pageContext.request.contextPath}/news.action">产业政策</a></li>
                  <%--<li><a href="${pageContext.request.contextPath}/product_showProducts.action?s_product.type=1">精品展示</a></li>--%>
                  <%--<li>	<a href="${pageContext.request.contextPath}/product_showProducts.action?s_product.type=2">新品上市</a></li>--%>
                   ...
                   <li id="tt"><a href=''>购物服务</a> 
       				 <ul id="gouwu">
           				 <li><a href="${pageContext.request.contextPath}/product_showProducts.action?s_product.type=0">订单服务</a></li>
               ...
               <li><a href="">交易商城</a></li>
				...
				<li><a href="${pageContext.request.contextPath}/goods!goodGoodsListxxx.action">会员服务</a></li>
				<li><a href="">联系我们</a></li>
