<%@ page language="java" import="com.yicunyipin.entity.*" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
...
<!-- content start -->
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">确认信息</strong> / <small>Confirm information</small></div>
    </div>
    ...
    <div class="am-g">
       ...
       <div class="am-u-sm-18 am-u-md-15 am-u-md-pull-29">
          ...
          <form class="am-form am-form-horizontal"  action="tbuser_confirmMember.action" method="post" >
         
         
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label"><i class="require-red">*</i>产品厂家名称</label>
            <div class="am-u-sm-9">
              <input id="productName" name="tbUser.productName" size="50"  type="text" value="${currentUser.productName}" readonly="readonly">
            </div>
          </div>
		...
		<!--  	<div class="am-form-group">
	          ...
	          <div class="am-u-sm-9">
	            ...
	            <%if(u.getType() == 1){ %>
	                ...
	                <input  type="text" size="50" value="普通会员" readonly="readonly">
	              
	              <%}else if(u.getType() == 2){ %>

					 <input  type="text" size="50" value="VIP会员" readonly="readonly">
	              <%} %>
	            </div>
	          </div>
	        </div>-->
	     <%if(u.getType() == 1){ %>
	     <div class="am-form-group">
            <label for="user-email" class="am-u-sm-3 am-form-label">*</i>会&nbsp;&nbsp;员&nbsp;&nbsp;类&nbsp;&nbsp;别</label>
            <div class="am-u-sm-9">
              <input  id="legal" size="50"  type="text" value="普通会员" readonly="readonly">
              <small></small>
            </div>
          </div>  
           <%}else if(u.getType() == 2){ %>
          <div class="am-form-group">
            <label for="user-email" class="am-u-sm-3 am-form-label">*</i>会&nbsp;&nbsp;员&nbsp;&nbsp;类&nbsp;&nbsp;别</label>
            <div class="am-u-sm-9">
              <input  id="legal" size="50"  type="text" value="VIP会员" readonly="readonly">
              <small></small>
            </div>
          </div> 
	     <%} %>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input name="tbUser.provinceCity"  id="legal" size="50"  type="text" value="${currentUser.provinceCity}" readonly="readonly">
              <small></small>
            </div>
          </div>      
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input name="tbUser.memberName"  id="legal" size="50"  type="text" value="${currentUser.memberName}" readonly="readonly">
              <small></small>
            </div>
          </div>                
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input name="tbUser.legal"  id="legal" size="50"  type="text" value="${currentUser.legal}" readonly="readonly">
              <small></small>
            </div>
          </div>
     <hr/>	      
            ...
            <div class="am-u-sm-9">
              <input  name="tbUser.contactName" id="contactName" value="${currentUser.contactName}" type="text" placeholder="输入会员联系人名称 ">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input name="tbUser.address"  id="legal" size="50" value="${currentUser.address}" type="text" placeholder="输入厂家地址 ">
              <small></small>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input name="tbUser.phoneNum"  id="legal" size="50" value="${currentUser.phoneNum}" type="text" placeholder="输入手机号 ">
              <small></small>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input name="tbUser.telNum"  id="legal" size="50" value="${currentUser.telNum}" type="text" placeholder="输入固话 ">
              <small></small>
            </div>
          </div>
           ...
           <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input name="tbUser.factoryInfo"  id="legal" size="500" value="${currentUser.factoryInfo}" type="text" placeholder="输入厂家信息 ">
              <small></small>
            </div>
          </div>
	...
	--> 
           ...
           <!--  <label for="user-weibo" class="am-u-sm-3 am-form-label">当前状态：</label> -->
              <input  type="hidden" id="status2" name="tbUser.type"  size="50" value="${currentUser.type }"  >
              ...
              <input  type="hidden" id="goodsId" name="tbUser.awardPic" value="${currentUser.awardPic}"/>
              
              <input  type="hidden" id="goodsId" name="tbUser.addressPic" value="${currentUser.addressPic}"/>
              
              <input  type="hidden" id="goodsId" name="tbUser.licencePic" value="${currentUser.licencePic}"/>
              
              <input  type="hidden" id="goodsId" name="type" value="${currentUser.type}"/>
          </div>  	
			 <hr/>		
					
          <div class="am-form-group">
            <div class="am-u-sm-9 am-u-sm-push-3">
              <input id="btn" type="submit" class="am-btn am-btn-primary" value="保存修改">&nbsp;&nbsp;&nbsp;&nbsp;
