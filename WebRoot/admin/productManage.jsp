...
<table id="dg" title="商品管理" class="easyui-datagrid" fitColumns="true" 
    ...
    <thead>
    	<tr>
    		...
    		<th field="address" width="100" align="center" formatter="">商品地址</th>
...
<div id="dlg" class="easyui-dialog" style="width: 670px;height: 500px;padding: 10px 20px"
  ...
  <form id="fm" method="post"  enctype="multipart/form-data">
  	<table cellspacing="8px;">
  		...
  		<tr>
  			<td>厂商：</td>
  			<td colspan="4"><input class="easyui-validatebox" id="csName" name="product.user.csName"   style="width: 300px;" disabled /></td>
  		</tr>
  		<tr>
  			<td>电话：</td>
  			<td colspan="4"><input class="easyui-validatebox" id="tel" name="product.tel"  disabled /></td>
  		</tr>
  		...
  		<tr>
  			<td>具体地址：</td>
  			<td colspan="4"><input class="easyui-validatebox" id="address" name="product.address"   style="width: 300px;" disabled /></td>
  		</tr>
  		<tr>
