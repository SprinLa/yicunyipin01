...
<table id="dg" title="新品" class="easyui-datagrid" fitColumns="true" 
    pagination="true" rownumbers="true" url="tbproduct_list.action?verified=1&type=2" fit="true" toolbar="#tb">
    <thead>
    	<tr>
