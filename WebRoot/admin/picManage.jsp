...
<script type="text/javascript">
	...
	function formatPro1(val,row){
		return row.product.user.trueName;
	}
</script>
</head>
<body style="margin: 1px;">
<table id="dg" title="商品管理" class="easyui-datagrid" fitColumns="true" 
    pagination="true" rownumbers="true" url="picture_list.action" fit="true" toolbar="#tb">
    <thead>
    	<tr>
    		<th field="cb" checkbox="true" align="center"></th>
    		<th field="picId" width="50" align="center">编号</th>
    		<th field="picName" width="150" align="center" formatter="formatProPic" >图片</th>
    		<th field="picType" width="150" align="center" >图片类型</th>
    		<th field="product" width="50" align="center" >商品</th>
    	<!-- 	<th field="publishTime" width="100" align="center" >上线时间</th>
    		...
    		<th field="staus" width="100" align="center" formatter="formatstaus">状态</th>
     -->		
    	</tr>
    </thead>
</table>
...
<div id="dlg" class="easyui-dialog" style="width: 670px;height: 500px;padding: 10px 20px"
  ...
  <form id="fm" method="post"  enctype="multipart/form-data">
  	<table cellspacing="8px;">
  		...
  		<tr>
  			<td>厂商：</td>
  			<td colspan="4"><input class="easyui-validatebox" id="csname" name="product.csName"  required="true" style="width: 300px;"/></td>
  		</tr>
  		<tr>
  			<td>价格：</td>
  		...
  		<tr>
  			<td>电话：</td>
  			<td colspan="4"><input class="easyui-validatebox" id="price" name="product.tel"  required="true"/></td>
  		</tr>
  		<tr>
  			<td>邮编：</td>
  			<td colspan="4"><input class="easyui-validatebox" id="price" name="product.zipcode"  required="true"/></td>
  		</tr>
  		<tr>
  			<td>商品图片：</td>
  		...
  		<tr>
  		 ...
  		 <tr>
  			<td>省：</td>
  			<td colspan="4"><input class="easyui-combobox" id="pName" name="product.province.pid"  data-options="panelHeight:'auto',editable:false,valueField:'pid',textField:'pname',url:'address_pcomboList.action'"/></td>
  		</tr>
  		<tr>
  			<td>市：</td>
  			<td colspan="4"><input class="easyui-combobox"  id="cName" name="product.city.cid" data-options="panelHeight:'auto',editable:false,valueField:'cid',textField:'cname',url:'address_ccomboList.action'" /></td>
  		</tr>
  		
  		 <tr>
  			<td>县：</td>
  			<td colspan="4"><input class="easyui-combobox" id="tName" name="product.town.tid"  data-options="panelHeight:'auto',editable:false,valueField:'tid',textField:'tname',url:'address_tcomboList.action'"/></td>
  		</tr>
  		<tr>
  			<td>具体地址：</td>
  			<td colspan="4"><input class="easyui-validatebox" id="csname" name="product.address"  required="true" style="width: 300px;"/></td>
  		</tr>
  		<tr>
