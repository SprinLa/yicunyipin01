...
<table id="dg" title="精品" class="easyui-datagrid" fitColumns="true" 
    pagination="true" rownumbers="true" url="tbproduct_list.action?verified=1&type=1" fit="true" toolbar="#tb">
    <thead>
    	<tr>
    		...
    		<th field="verified" width="100" align="center"  formatter="formatstatus" hidden="true">状态</th>
    		...
    		<th field="addTime" width="100" align="center" >成为会员产品的时间</th>
