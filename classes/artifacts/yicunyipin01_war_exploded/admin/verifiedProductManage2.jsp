...
<table id="dg" title="审核未通过产品" class="easyui-datagrid" fitColumns="true" 
    pagination="true" rownumbers="true" url="tbproduct_list.action?verified=2" fit="true" toolbar="#tb">
    <thead>
    	<tr>
