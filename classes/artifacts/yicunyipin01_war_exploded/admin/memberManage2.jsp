...
<table id="dg" title="VIP会员" class="easyui-datagrid" fitColumns="true" 
    pagination="true" rownumbers="true" url="tbuser_list.action?verified=1&type1=2" fit="true" toolbar="#tb">
    <thead>
    	<tr>
    		...
    		<th field="memberTime" width="100" align="center" >成为会员的时间</th>
