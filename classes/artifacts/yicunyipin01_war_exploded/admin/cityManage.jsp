...
<script type="text/javascript">
	...
	function openCityModifyDialog(){
		...
		$("#dlg").dialog("open").dialog("setTitle","编辑市信息");
		$("#name").val(row.cname);
		//$("#remarks").val(row.remarks);
		$("#bName").combobox("setValue",row.province.pid);
		url="address_csave.action?city.cid="+row.cid;
	}
...
<table id="dg" title="产地市（地级市）" class="easyui-datagrid" fitColumns="true" 
...
<div id="tb">
	<div>
		<a href="javascript:openCityAddDialog()" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加</a>
		<a href="javascript:openCityModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">修改</a>
		<a href="javascript:deleteCity()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">删除</a>
	</div>
	<!--  <div>
...
<div id="dlg-buttons">
	<a href="javascript:saveCity()" class="easyui-linkbutton" iconCls="icon-ok" >保存</a>
