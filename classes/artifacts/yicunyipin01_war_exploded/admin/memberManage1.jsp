...
<table id="dg" title="普通会员" class="easyui-datagrid" fitColumns="true" 
    pagination="true" rownumbers="true" url="tbuser_list.action?verified=1&type1=1" fit="true" toolbar="#tb">
    <thead>
    	<tr>
