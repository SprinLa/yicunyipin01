				...
				<%--<c:forEach var="address" items="${addressList}" varStatus="status">--%>
					<%--<li class="js_toggle">--%>
						...
						<%--<c:forEach var="address1" items="${address.provinceList}" varStatus="status">	--%>
							    <%--<a href="product_showProducts.action?s_product.province.pid=${address1.pid}">${address1.pname}</a>--%>
						<%--</c:forEach>	--%>
							<%--</p>--%>
							<%--<em>&gt;</em>--%>
						<%--</div>--%>
						<%--<div class="menu-item menu-in">--%>
							<%--<div class="area-bg">--%>
								<%--<ul class="sublist clearfix">--%>
									<%--<c:forEach var="address1" items="${address.provinceList}" varStatus="status">--%>
									<%--<li>--%>
										<%--<h3 class="product_showProducts.action?s_product.province.pid=${address1.pid}"><span>${address1.pname}</span></h3>--%>
										<%--<p class="mcate-item-bd">--%>
										<%--<c:forEach var="address2" items="${address1.cityList}" varStatus="status">--%>
											<%--<a href="product_showProducts.action?s_product.city.cid=${address2.cid}">${address2.cname}</a>--%>
										<%--</c:forEach>--%>
										<%--</p>--%>
									<%--</li>--%>
									  <%--</c:forEach>--%>
