...
<div class="admin-content">
  ...
  <form name="form1" action="tbproduct_productAdd.action" method="post" enctype="multipart/form-data" >
	...
	<!--  		<div class="am-g am-margin-top-sm">
            ...
            <div class="am-u-sm-8 am-u-end">
               <div class="am-g am-margin-top">
				  <div class="am-u-sm-4">
					 <select id="province" name="product.province.pid">  
	  						<option value="">请选择</option>  
					 </select> 
				  </div>	

					<div class="am-u-sm-4">
					 <select id="city" name="product.city.cid" >  
	        				<option value="">请选择</option>  
	    			</select> 
				  </div>	

						<div class="am-u-sm-4">
							<select id="town" name="product.town.tid"  >  
       						    <option value="">请选择</option>  
    			            </select>
						  </div>					  
               </div>
		  ...
		  <div class="am-g am-margin-top-sm">
            ...
            <div class="am-u-sm-6 am-u-end">
              <div class="am-g am-margin-top">
				  <div class="am-u-sm-6">
					 <select id="bigCategory" name="type1" >  
	  						<option value="">请选择</option>  
						 </select>  
				  </div>	

					<div class="am-u-sm-6">
					 <select id="smallCategory" name="type2"  >  
	        				<option value="">请选择</option>  
	    				 </select>  
				  </div>	
  ...
  <hr/>
     ...
     <!--    <div class="am-g am-margin-top-sm">
         ...
         <div class="am-g am-margin-top-sm">
           ...
           -->  
  		<div class="am-g am-margin-top-sm">
            <div class="am-u-sm-2 am-text-right"><i class="require-red">*&nbsp;</i>产地 </div>
            <div class="am-u-sm-4 ">
              <input type="text" name="tbProduct.address"  id="name"   class="am-form-field am-input-sm">
            </div>
	  ...
	  <div class="am-g am-margin-top-sm">
	            ...
	            <div class="am-u-sm-4 am-u-end">
	              <input type="text" id="csName" name="tbProduct.productInfo "  class="am-form-field am-input-sm"> 
	            </div>
	   </div>
		...
		<div class="am-g am-margin-top-sm">
		            ...
		            <div class="am-u-sm-4 am-u-end">
		              <input type="text" id="price" name="tbProduct.price " class="am-form-field am-input-sm">
		            </div>
		   </div>
	...
	<div class="am-g am-margin-top-sm">
	            ...
	            <div class="am-u-sm-4 am-u-end">
	              <input type="text" id="tel" name="tbProduct.productAddressInfo"  class="am-form-field am-input-sm" >
	             <small id="txtmobile"></small>
	            </div>
	   </div>   
	    ...
	    <hr/>
		   ...
		   <div class="am-g am-margin-top-sm">
            ...
            <div class="am-u-sm-4 am-u-end">
              <input type="file" class="am-input-sm" id="a" name="image" >
            </div>
          </div>
           ...
           <div class="am-g am-margin-top-sm">
            ...
            <div class="am-u-sm-4 am-u-end">
              <input type="file" class="am-input-sm" id="b" name="image"  >
            </div>
          </div>
            ...
            <div class="am-u-sm-4 am-u-end">
              <input type="file" class="am-input-sm" id="c" name="image">
            </div>
          </div>
		 ...
		 <div class="am-form">
		  ...
		  <div class="am-g am-margin-top-sm">
            ...
            <div class="am-u-sm-6 am-u-end">
              <div class="am-g am-margin-top">
				  <div class="am-u-sm-6">
					 <select id="bigCategory" name="product.bigType.id" >  
	  						<option value="">请选择</option>  
						 </select>  
				  </div>	

					<div class="am-u-sm-6">
					 <select id="smallCategory" name="product.smallType.id"  >  
	        				<option value="">请选择</option>  
	    				 </select>  
				  </div>	
