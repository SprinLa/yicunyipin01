...
<div region="center">
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			<div align="center" style="padding-top: 100px;"><font color="red" size="10">欢迎使用一村一品网后台管理系统</font></div>
		</div>
	</div>
</div>
...
<div class="easyui-accordion" data-options="fit:true,border:false">
		<div title="用户管理"  data-options="selected:true,iconCls:'icon-user'" style="padding:10px;">
		     <a href="javascript:openTab('未审核用户','..../userManage0.jsp','icon-user')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-manage'" style="width: 150px;">未审核用户</a>
		    <a href="javascript:openTab('审核通过用户','./userManage2.jsp','icon-user')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-manage'" style="width: 150px;">审核通过用户</a>
		    <a href="javascript:openTab('审核未通过用户','../admin/userManage1.jsp','icon-user')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-manage'" style="width: 150px;">审核未通过用户</a>
			<a href="javascript:openTab('全部用户','..../userManage.jsp','icon-user')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-manage'" style="width: 150px;">全部用户</a>
		...
		<div title="地区管理"  data-options="iconCls:'icon-tag'" style="padding:10px">
			<a href="javascript:openTab('省管理','provinceManage.jsp','icon-product')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-manage'" style="width: 150px;">管理省</a>
			<a href="javascript:openTab('市管理','cityManage.jsp','icon-product')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-manage'" style="width: 150px;">管理市</a>
			<a href="javascript:openTab('县管理','townManage.jsp','icon-product')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-manage'" style="width: 150px;">管理县</a>
		</div>
